...
# Read all skills from a text file or directly from multiline string
skills_text = """
.NET
360-degree video
3D Animation
...
skills = [line.strip() for line in skills_text.strip().split("\n") if line.strip()]

# Save to JSON file
with open("skills_db.json", "w") as f:
    json.dump(skills, f, indent=4)

print("✅ Skills saved to skills_db.json successfully!")
